...
def mock_video():
    ...
    video.markPlayed = MagicMock()
    video.markUnplayed = MagicMock()
    video.rate = MagicMock()
    ...
    # Metadata editing
    video.editTitle = MagicMock()
    video.editSummary = MagicMock()
    video.editSortTitle = MagicMock()
    video.editUserRating = MagicMock()
    video.editAudienceRating = MagicMock()
    video.editCriticRating = MagicMock()
    video.editContentRating = MagicMock()
    video.editOriginalTitle = MagicMock()
    video.editOriginallyAvailable = MagicMock()
    video.editStudio = MagicMock()
    video.editTagline = MagicMock()
    video.editAddedAt = MagicMock()
    # Match/unmatch
    video.matches = MagicMock(return_value=[])
    video.fixMatch = MagicMock()
    video.unmatch = MagicMock()
    # Split/merge
    video.split = MagicMock()
    video.merge = MagicMock()
    # Art (set/upload/lock/unlock/delete)
    video.setArt = MagicMock()
    video.setPoster = MagicMock()
    video.uploadArt = MagicMock()
    video.uploadPoster = MagicMock()
    video.lockArt = MagicMock()
    video.unlockArt = MagicMock()
    video.lockPoster = MagicMock()
    video.unlockPoster = MagicMock()
    video.deleteArt = MagicMock()
    video.deletePoster = MagicMock()
    return video
...
def mock_server():
    ...
    mock_client.seekTo = MagicMock()
    mock_client.skipNext = MagicMock()
    mock_client.skipPrevious = MagicMock()
    mock_client.stepForward = MagicMock()
    mock_client.stepBack = MagicMock()
    mock_client.setVolume = MagicMock()
    mock_client.setAudioStream = MagicMock()
    mock_client.setSubtitleStream = MagicMock()
    mock_client.setVideoStream = MagicMock()
    mock_client.setShuffle = MagicMock()
    mock_client.setRepeat = MagicMock()
    mock_client.goToHome = MagicMock()
    mock_client.goToMedia = MagicMock()
    mock_client.goToMusic = MagicMock()
    mock_client.moveUp = MagicMock()
    mock_client.moveDown = MagicMock()
    mock_client.moveLeft = MagicMock()
    mock_client.moveRight = MagicMock()
    mock_client.select = MagicMock()
    mock_client.goBack = MagicMock()
    mock_client.toggleOSD = MagicMock()
    mock_client.contextMenu = MagicMock()
    mock_client.pageUp = MagicMock()
    mock_client.pageDown = MagicMock()
    mock_client.nextLetter = MagicMock()
    mock_client.previousLetter = MagicMock()
    mock_client.playMedia = MagicMock()
    mock_client.isPlayingMedia = MagicMock(return_value=False)
    server.clients = MagicMock(return_value=[mock_client])
    server.client = MagicMock(return_value=mock_client)
